...
url = 'https://cn.tradingview.com/markets/stocks-hong-kong/sectorandindustry-sector/miscellaneous/'
...
formatted_numbers = [f"{num.zfill(4)}.HK" if len(num) <= 4 else f"{num}.HK" for num in numbers]
save_directory = r"F:/HC/Semester 5/DB/data/HK/anomaly"
os.makedirs(save_directory, exist_ok=True)
sector_name = os.path.basename(save_directory)

for stock in formatted_numbers:
